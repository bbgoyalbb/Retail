...
export default function MobileTopBar({ title, onMenuClick }) {
  return (
    <header className="lg:hidden fixed top-0 left-0 right-0 z-50 h-12 bg-[var(--surface)] border-b border-[var(--border-subtle)] flex items-center px-3 gap-3 shadow-sm">
      <button
        onClick={onMenuClick}
